...
public class ResourceVersionMojo extends ResourceMojo {
    ...
    public String resolveJsRefer(String page) {
        ...
        while (true) {
            ...
            String prefix = pfull.substring(0, matcher.start(1) - matcher.start());
            String among = versionStaticURL(jsdirPart);
            String group2 = (null==matcher.group(2) ? "" :matcher.group(2));
            pfull = prefix + among + (pfull.substring((prefix + jsdirPart + group2).length()));
